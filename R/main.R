...
elec_slide_mean_plot <- ggplot() +
  ...
  theme_bw() +
  transition_manual(group)
anim_save("img/slide-mean.gif", elec_slide_mean_plot, width = 800, height = 250)
...
elec_tile_mean_plot <- ggplot() +
  ...
  theme_bw() +
  transition_manual(group)
anim_save("img/tile-mean.gif", elec_tile_mean_plot, width = 800, height = 250)
...
elec_stretch_mean_plot <- ggplot() +
  ...
  theme_bw() +
  transition_manual(group)
anim_save("img/stretch-mean.gif", elec_stretch_mean_plot, width = 800, height = 250)
